...
set_false_path -from [get_keepers *$nios_system_cpu_cpu_oci_break_path|dbrk_hit?_latch] -to [get_keepers *$nios_system_cpu_cpu_jtag_sr*]
set_false_path -from [get_keepers *$nios_system_cpu_cpu_oci_break_path|trigbrktype] -to [get_keepers *$nios_system_cpu_cpu_jtag_sr*]
set_false_path -from [get_keepers *$nios_system_cpu_cpu_oci_break_path|trigger_state] -to [get_keepers *$nios_system_cpu_cpu_jtag_sr*]
